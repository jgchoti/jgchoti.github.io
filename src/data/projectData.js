export const projectData = [
    {
        name: "Online Resume",
        description: "In this project for beginners, I took my first steps into the exciting world of web development. I learned the ABCs of HTML, CSS, and JavaScript while making my very own landing page.",
    ...
    {
        name: "Weather App",
        description: "In this project, I jumped into the world of live API to make a dynamic weather app. I aimed for a design that's user-friendly. It shows the weather info in a way that's not only easy on the eyes but also easy to understand. People can get the latest on weather conditions, forecasts, and what's happening in their area, all thanks to the API integration.",
