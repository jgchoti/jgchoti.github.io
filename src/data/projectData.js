export const projectData = [
    ...
    },
    {
        ...
        imageUrl: process.env.PUBLIC_URL + "/assets/images/calculator.png",
        alternate_image: process.env.PUBLIC_URL + "/assets/images/calculator_dark.png",
    ...
    },
    {
        ...
        imageUrl: process.env.PUBLIC_URL + "/assets/images/todo.png",
        ...
        imageUrl: process.env.PUBLIC_URL + "/assets/images/studio_ghibli.png",
        alternate_image: process.env.PUBLIC_URL + "/assets/images/studio_ghibli_light.png",
